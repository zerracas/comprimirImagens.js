...
<!-- ======================================================================================================== -->
<!-- 1. INCLUDES -->
<script language='javascript' src='/cocamar/jsbiblio/ajax.js'></script>
<script language='javascript' src='/cocamar/jsbiblio/ajax3.js'></script>
<script language='javascript' src='/cocamar/jsbiblio/events.js'></script>
<script language='javascript' src='/cocamar/jsbiblio/formata.js'></script>
<script language="javascript" src="/cocamar/jsbiblio/ssBusca.js"></script>
...
function event_change(obj){
   switch (obj.id) {
   case 'foto':
      alterouAnexo(document.form.foto,'foto_img'); // imagens.js
      break;
   ...
...
// 3. SALVAR A IMAGEM
...
conteudo[04] = geraArquivoReduzido("foto", "foto_img", 1280); // imagens.js - idFile, idPrevia, max_size (width, height)
conteudo[09] = getNomeArquivo("foto"); // imagens.js - idFile
ssBuscaAjax(prog, solicitante, basebusca,conteudo,[''],false,false,[''],false,''); // ssBusca.js
...
...
function comprimirArquivo(loadedData, max_size) {
   ...
   ***/
   ...
   if (img.width < 1920 || img.height < 1920) q = 0.7;
   if (img.width <  600 || img.height <  600) q = 0.8;
...
function geraArquivoReduzido(idFile, idPrevia, max_size){
   ...
   var dataURL = comprimirArquivo(prev, max_size);
